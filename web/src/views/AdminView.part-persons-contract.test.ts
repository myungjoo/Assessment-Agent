...
// AdminView 소속 인원 조회 call site(T-1893 이후 useAdminParts hook) 의 발사 method 추론.
// `useApiResource<PersonRow[]>(partPersonsPath)` 를
...
const WEB_FIRE_METHOD = extractPersonsFireMethod(PARTS_HOOK_SOURCE);
