...
| UC-07 | Export / Import / Backup / Restore | Admin | Web UI, Backend API, DB Persistence | WebModule, AssessmentModule ([modules.md](../architecture/modules.md) 39 행 정본 기준 미shipped placeholder — export/import 실 shipped 코드의 module 귀속은 정본 12 표에 아직 미기재라 후속 slice 소관. 병기는 부기라 [UC-07](UC-07-export-import.md) §9 의 `4 module` 산정 불변), AuthModule, PersistenceModule | REQ-030, REQ-032, REQ-045 | DONE |
