...
- [ ] `test/helpers/realdata-devset-logins-doc-consistency.ts` 신설 — 다음 3 개 public symbol 만 export:
...
- [ ] `test/helpers/realdata-devset-logins-doc-consistency.spec.ts` 신설 (colocated). 아래 R-112 4 종을 모두 cover:
...
- [ ] 새 dependency 0 — `node:fs` · `node:path` 와 기존 helper import 만 사용.
- [ ] `docs/ops/realdata-scale-devset.md` · `test/load/realdata-devset-logins.json` · `test/helpers/realdata-devset-logins.ts` · `src/` · `.github/workflows/` · `package.json` 변경 0.
