...
3. **`modules.md` 192 행 `8 component 와 본 문서의 11 module` vs 실측 module row **12** 의 1 어긋남 정정** — 본 slice AC 1 (ii) 실측으로 확정될 선행 불일치 (Follow-up 2 와 동형의 수치 drift).
