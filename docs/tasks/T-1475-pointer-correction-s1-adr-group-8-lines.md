...
- [ ] **AC 3 — 8 행 in-place 정정 실집행**: AC 1 재대조 · AC 2 화법에 따라 다음 8 행만 고친다. **행 추가 · 삭제 없이 각 행 안에서 좌표 문자열만 교체** 한다 (본문 의미 · 어순 · REQ 번호 · 링크는 불변).
