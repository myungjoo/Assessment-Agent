...
| [UC-07](../use-cases/UC-07-export-import.md#5-main-flow-sequence-diagram) | step 1 (Admin → export 또는 import) | `POST /api/admin/export`, `POST /api/admin/import`, `POST /api/admin/import/preview`, `POST /api/admin/backup`, `POST /api/admin/restore` |
