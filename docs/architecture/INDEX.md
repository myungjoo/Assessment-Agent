...
| [deployment.md](deployment.md) | Deployment view — monolith vs worker / DB / secrets / scheduler / 네트워크 boundary | T-A2 (P1) | 미작성 |
...
| ADR-0002 DB (TBD) | deployment.md + data-model.md | 미작성 — T-A2 또는 T-A2 후속에서 |
