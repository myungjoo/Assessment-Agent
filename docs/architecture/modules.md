...
| **UserModule** | 평가 대상 인원 CRUD + group / part 소속 / activate·deactivate (휴직 시 숨김) 의 service / controller. 평가 대상자 메타데이터 관리. | PersistenceModule, AuthModule | Backend API (user 부분) | REQ-026 (인원 CRUD), REQ-027 (group/part), REQ-028 (activate/deactivate) | ADR-0001 |
