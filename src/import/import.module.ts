...
//
// 책임 범위 (T-0489 배선 + T-1279 / T-1282 / T-1285 등록):
...
//   - ImportJobRunnerService provider 등록·export (T-1285, 실행 slice 3c-3b) — 위 3c-1 /
//     3c-2c 와 동형인 등록 한 겹. job status 전이와 복원 실행을 합성하는 runner (T-1284) 를
//     DI 에 올려 다음 slice 3c-3c 가 controller 에서 inject 만 하면 되게 한다. 여기서도
//     등록만 하고 호출처는 0.
//
...
@Module({
  ...
  // ImportJobRunnerService 등록·export (T-1285) — 후속 3c-3c controller 배선이 inject 할 대상.
  providers: [
    ImportJobService,
