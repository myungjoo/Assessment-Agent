...
//
// api.md / p4-impl-plan §2 정합 (read-only 목록 slice 만 — config CRUD 는 Follow-up):
...
//   - POST/PATCH/DELETE config CRUD — Follow-up #1 (본 controller 는 GET 목록만).
//   - GET /api/llm/providers/:id 단건 조회 — Follow-up #2.
